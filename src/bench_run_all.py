...
Usage:
    python src/bench_run_all.py              # run all 6 phases
    python src/bench_run_all.py 1 2 4        # run only phases 1, 2, 4
    python src/bench_run_all.py --serial     # no parallelism, run 1-6 sequentially
