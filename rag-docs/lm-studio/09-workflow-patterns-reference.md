...
<<<<<<< HEAD
→ Example response format: "Silver is trading at [tool-returned price] ([source_name](tool-returned-url))."
=======
...
<<<<<<< HEAD
→ Tavily("current silver price per ounce") → [tool-returned price] from [source_name]
→ Example response format: "Silver is at [tool-returned price] ([source_name](tool-returned-url))." One call.
=======
...
<<<<<<< HEAD
- **Lookup** (price, score, status, single fact): Call the tool first, then 1-3 sentences built from the tool result with source link. Stop.
=======
