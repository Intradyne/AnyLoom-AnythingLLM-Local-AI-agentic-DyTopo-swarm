...
The helper module already exists at `src/benchmark_helpers.py`. It provides: `init()`, `send()`, `has_dollar_amount()`, `has_headers()`, `has_bullets()`, `has_url()`, `suggests_agent_mode()`, `claims_file_read()`, `update_topn()`, `get_workspace_settings()`.

**Add this new function** to `src/benchmark_helpers.py`:
...
Save results to `docs/benchmarker_phase1_explanation.json`.
...
Save results to `docs/benchmarker_phase2_adversarial.json`.
...
Save results to `docs/benchmarker_phase3_workspace.json`.
...
Save results to `docs/benchmarker_phase4_stability.json`.
...
Save results to `docs/benchmarker_phase5_lmstudio.json`.
...
Save to `docs/benchmarker_phase6_showcase.json`.
