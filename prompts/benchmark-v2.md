...
Write these to `src/benchmark_helpers.py` and import them throughout:
...
4. Writes results to a JSON file: `docs/phase1_{category}.json`
...
Write sweep results to `docs/phase2_topn_sweep.json`.
...
Read results from `docs/phase1_fabrication.json`, `docs/phase1_tool_boundary.json`, `docs/phase1_depth.json`, and `docs/phase2_topn_sweep.json`. Build this table:
